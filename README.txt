...
Il drago decorativo usa `dragon-fly-animated.webp`, un'animazione con un leggero battito d'ali.
Il movimento destra/sinistra durante lo scroll resta gestito da `script.js`.
Il file originale `dragon-fly.png` è stato lasciato nel progetto come backup.
